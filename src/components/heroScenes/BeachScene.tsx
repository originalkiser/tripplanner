...
//
// This is the only hero scene using the three-tier hand-tuned viewBox
// approach above — it predates multi-theme support and earned that
// precision the hard way (see the git history of bugs it fixes). The other
// themes (Mountain/City/AmusementPark) deliberately use a simpler
// single-viewBox "slice" fit instead — see the comment atop MountainScene.tsx
// for why that's a reasonable, lower-risk tradeoff for scenes without that
// history.
